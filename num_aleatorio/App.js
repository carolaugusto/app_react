    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.frame}>
          <Image
            source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFJhwJ4SMwO0K_LID67j16TAdnTrpcJBaqMQ&usqp=CAU' }}
        ...
        <Pressable onPress={() => this.descobrir()} style={[styles.button, styles.buttonColor]}>
